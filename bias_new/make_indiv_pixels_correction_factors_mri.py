...
historic_dir = "/gws/ssde/j25b/bas_climate/users/clelland/model/full_bias_corr/inputs_raw/MRI-ESM2-0/historical"

scenario_dirs = {
    "ssp126": "/gws/ssde/j25b/bas_climate/users/clelland/model/full_bias_corr/inputs_raw/MRI-ESM2-0/ssp126",
    "ssp245": "/gws/ssde/j25b/bas_climate/users/clelland/model/full_bias_corr/inputs_raw/MRI-ESM2-0/ssp245",
    "ssp370": "/gws/ssde/j25b/bas_climate/users/clelland/model/full_bias_corr/inputs_raw/MRI-ESM2-0/ssp370"
}
    ...
    for month in range(1, 13):
        ...
        with rio.open(obs_files[0]) as src_template:
            ...
            output_path = os.path.join(
                output_dir,
                f"bias_correction_factors_MRI-ESM2-0_{scenario}_{month:02d}.tif"
            )
